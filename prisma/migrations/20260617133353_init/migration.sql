...
CREATE TABLE "movies" (
    ...
    "top_sum" INTEGER NOT NULL DEFAULT 0,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "reviews" (
    ...
    "top_percentage" INTEGER NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "reviews_author_id_movie_tmdb_id_key" ON "reviews"("author_id", "movie_tmdb_id");
...
-- AddForeignKey
ALTER TABLE "reviews" ADD CONSTRAINT "reviews_movie_tmdb_id_fkey" FOREIGN KEY ("movie_tmdb_id") REFERENCES "movies"("tmdb_id") ON DELETE RESTRICT ON UPDATE CASCADE;
